...
public class JsonApi_phar extends AsyncTask<String, String, String> {
...
//            Log.d("CoronaApi", "The response is :" + result);
            ...
            for (int i = 0; i < Api.length(); i++) {
                ...
                phar_item phar_item = new phar_item(
                        item.getString("lat"),
                        item.getString("lon"),
                        item.getString("name"),
...
//                        item.getString("holiday"),
                ...
                MainActivity.phar_list.add(phar_item);
    ...
    public class phar_item {
        ...
        public phar_item(String lat, String lng, String name, String location, String phone, String mono, String monc, String tueo, String tuec, String wedo, String wedc, String thuo, String thuc, String frio, String fric, String sato, String satc, String suno, String sunc, String holo, String holc) {
            this.lat = lat;
            this.lng = lng;
            this.name = name;
